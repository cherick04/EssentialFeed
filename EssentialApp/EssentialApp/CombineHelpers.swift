...
//  EssentialApp
//
//  Created by Erick Chacon on 11/22/22.
//
...
typealias AnyDispatchQueueScheduler = AnySheduler<DispatchQueue.SchedulerTimeType, DispatchQueue.SchedulerOptions>
...
extension Scheduler {
    func eraseToAnyScheduler() -> AnySheduler<SchedulerTimeType, SchedulerOptions> {
        AnySheduler(self)
    }
}

struct AnySheduler<SchedulerTimeType: Strideable, SchedulerOptions> : Scheduler where SchedulerTimeType.Stride: SchedulerTimeIntervalConvertible {
