...
//  EssentialAppTests
//
//  Created by Erick Chacon on 11/30/22.
//
...
class CommentsUIIntegrationTests: XCTestCase {
    ...
    func test_loadCommentsActions_requestCommentsFromLoader() {
        ...
        sut.loadViewIfNeeded()
        XCTAssertEqual(loader.loadCommentsCallCount, 1, "Expected a loading request once a view is loaded")
        
        sut.simulateUserInitiatedReload()
        XCTAssertEqual(loader.loadCommentsCallCount, 1, "Expects no request until previous completes")
